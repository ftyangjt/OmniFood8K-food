...
parser.add_argument('--save_dir', type=str, default='./trained_weights',
                    help='checkpoint root directory inside this repository')
...
def test(epoch, net):
        ...
        if best_loss > loss_pmae:
            ...
            check_dirs(savepath)
            ckpt_path = os.path.join(savepath, "ckpt_best.pth")
